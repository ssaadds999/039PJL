                    ...
                    <div className="overflow-x-auto">
                      <table className="w-full">
                        ...
                        <tbody className="bg-white divide-y divide-gray-100">
                          {requests.map((req) => (
                            <tr key={req.requestId} className="hover:bg-gradient-to-r hover:from-blue-50/50 hover:to-cyan-50/50 transition-all duration-200">
                              ...
                              <td className="px-6 py-4 text-sm font-bold text-gray-800">
                                ฿{Number(req.amount).toLocaleString("th-TH", {
